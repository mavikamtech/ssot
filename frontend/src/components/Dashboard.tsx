  ...
  const handleCSVUpload = async () => {
    ...
    try {
      ...
      await logAccess({
        ...
        method: 'POST',
        description: `Uploading CSV file: ${csvFile.name}`
      });
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        {/* Results and Upload Section - Responsive Layout */}
        {data && data.loanCashFlow && data.loanCashFlow.byLoanCode && (
          <div style={{ 
            ...
            {/* Upload CSV Section - Right sidebar */}
            <div style={{ 
              width: windowWidth > 1024 ? '400px' : '100%',
              flexShrink: 0,
              marginBottom: '2rem', 
              padding: '1.5rem', 
              background: '#f8f9fa', 
              ...
              <p style={{ marginBottom: '1rem', fontSize: '0.9rem', color: '#6c757d' }}>
                Upload a CSV file with loan cash flow data. Required columns: cashflowBasedOnMonthEnd
              </p>
