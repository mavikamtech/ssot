...
func (r *loanCashFlowsResolver) ByLoanCode(ctx context.Context, obj *model.LoanCashFlows, loanCode []*string) ([]*model.LoanCashFlow, error) {
	...
	if err != nil {
		...
		return r.ServiceManager.LoanCashFlowService.GetByLoanCodes(ctx, loanCode, columnPermissions)
	}

	// Use the enhanced service method with field filtering
	return r.ServiceManager.LoanCashFlowService.GetByLoanCodesWithFieldFilters(ctx, loanCode, columnPermissions, fieldFilters)
}
